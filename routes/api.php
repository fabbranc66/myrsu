...
use App\Controllers\Api\EmailController;
...
use App\Controllers\Api\RoomAccessLinkController;
use App\Controllers\Api\RoomAttachmentController;
use App\Controllers\Api\RoomDocumentController;
use App\Controllers\Api\RoomExternalAccessController;
use App\Controllers\Api\RoomMessageController;
use App\Controllers\Api\RoomNormativaController;
use App\Controllers\Api\RoomParticipantController;
...
$rooms = new RoomController($app);
$roomAccessLinks = new RoomAccessLinkController($app);
$roomAttachments = new RoomAttachmentController($app);
$roomDocuments = new RoomDocumentController($app);
$roomExternalAccess = new RoomExternalAccessController($app);
$roomMessages = new RoomMessageController($app);
$roomNormativa = new RoomNormativaController($app);
$roomParticipants = new RoomParticipantController($app);
...
$app->router->get('/api/v1/emails/{id}', [$emails, 'show']);
$app->router->patch('/api/v1/emails/{id}', [$emails, 'update']);
$app->router->delete('/api/v1/emails/{id}', [$emails, 'destroy']);
$app->router->post('/api/v1/emails/{id}/manage', [$emails, 'manage']);
...
$app->router->get('/api/v1/rooms/categories', [$rooms, 'categories']);
$app->router->get('/api/v1/rooms', [$rooms, 'index']);
$app->router->post('/api/v1/rooms', [$rooms, 'store']);
$app->router->get('/api/v1/rooms/{id}', [$rooms, 'show']);
$app->router->post('/api/v1/rooms/{id}/access-link', [$roomAccessLinks, 'create']);
$app->router->patch('/api/v1/rooms/{id}', [$rooms, 'update']);
$app->router->patch('/api/v1/rooms/{id}/status', [$rooms, 'status']);
$app->router->get('/api/v1/rooms/{id}/timeline', [$rooms, 'timeline']);
$app->router->get('/api/v1/rooms/{id}/participants/candidates', [$roomParticipants, 'candidates']);
$app->router->post('/api/v1/rooms/{id}/participants', [$roomParticipants, 'store']);
$app->router->delete('/api/v1/rooms/{id}/participants/{userId}', [$roomParticipants, 'destroy']);
$app->router->post('/api/v1/rooms/{id}/external-participants', [$roomParticipants, 'storeExternal']);
$app->router->delete('/api/v1/rooms/{id}/external-participants/{externalId}', [$roomParticipants, 'destroyExternal']);
$app->router->post('/api/v1/rooms/{id}/messages', [$roomMessages, 'store']);
$app->router->delete('/api/v1/rooms/{id}/messages/{messageId}', [$roomMessages, 'destroy']);
$app->router->get('/api/v1/rooms/{id}/documents/available', [$roomDocuments, 'available']);
$app->router->post('/api/v1/rooms/{id}/documents', [$roomDocuments, 'store']);
$app->router->delete('/api/v1/rooms/{id}/documents/{documentId}', [$roomDocuments, 'destroy']);
$app->router->get('/api/v1/rooms/{id}/documents/{documentId}/preview', [$roomDocuments, 'preview']);

$app->router->get('/api/v1/room-access', [$roomExternalAccess, 'show']);
$app->router->post('/api/v1/room-access/register', [$roomExternalAccess, 'register']);
$app->router->get('/api/v1/room-access/timeline', [$roomExternalAccess, 'timeline']);
$app->router->post('/api/v1/room-access/messages', [$roomExternalAccess, 'message']);
$app->router->get('/api/v1/room-access/documents/{documentId}/preview', [$roomExternalAccess, 'preview']);
$app->router->post('/api/v1/room-access/attachments', [$roomAttachments, 'store']);
$app->router->get('/api/v1/room-access/attachments/{id}', [$roomAttachments, 'show']);
$app->router->get('/api/v1/room-access/normativa/ricerca', [$roomNormativa, 'search']);
$app->router->get('/api/v1/room-access/normativa/unita/{id}', [$roomNormativa, 'unit']);
$app->router->post('/api/v1/room-access/normativa/unita/{id}/share', [$roomNormativa, 'share']);
...
$app->router->get('/api/v1/funds', [$funds, 'index']);
$app->router->post('/api/v1/funds/contracts', [$funds, 'storeContract']);
$app->router->patch('/api/v1/funds/contracts/{id}', [$funds, 'updateContract']);
$app->router->delete('/api/v1/funds/contracts/{id}', [$funds, 'destroyContract']);
$app->router->post('/api/v1/funds/contracts/{id}/protocol', [$funds, 'protocolContract']);
