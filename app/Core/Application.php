...
use App\Repositories\RoomDocumentRepository;
use App\Repositories\RoomAttachmentRepository;
...
use App\Services\RoomAttachmentStorageService;
use App\Services\RoomService;
use App\Services\RoomExternalInvitationService;
...
final class Application
{
    ...
    public readonly EmailRepository $emails;
    ...
    public readonly RoomParticipantRepository $roomParticipants;
    public readonly RoomTimelineRepository $roomTimeline;
    public readonly RoomDocumentRepository $roomDocuments;
    public readonly RoomAttachmentRepository $roomAttachments;
    public readonly RoomExternalAccessRepository $roomExternalAccess;
    public readonly RoomAccessService $roomAccess;
    public readonly RoomExternalInvitationService $roomExternalInvitations;
    public readonly RoomPermissionService $roomPermissions;
    public readonly RoomService $roomService;
    public readonly RoomAttachmentStorageService $roomAttachmentStorage;
    ...
    public function __construct(private readonly string $basePath)
    {
        ...
        $this->roomAttachmentStorage = new RoomAttachmentStorageService($this->basePath, new MediaDurationService());
    ...
    public function bootDatabase(): void
    {
        ...
        $this->roomParticipants = new RoomParticipantRepository($pdo);
        $this->roomTimeline = new RoomTimelineRepository($pdo);
        $this->roomDocuments = new RoomDocumentRepository($pdo);
        $this->roomAttachments = new RoomAttachmentRepository($pdo);
        $this->roomExternalAccess = new RoomExternalAccessRepository($pdo);
        $this->roomAccess = new RoomAccessService($this->roomExternalAccess);
        $this->roomExternalInvitations = new RoomExternalInvitationService(
            $this->roomExternalAccess,
            $this->users,
            $this->emailSmtp
        );
        $this->roomPermissions = new RoomPermissionService($this->roomParticipants, $this->roles);
        $this->roomService = new RoomService($pdo, $this->rooms, $this->roomParticipants, $this->roomTimeline);
