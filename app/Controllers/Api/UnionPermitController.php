...
use App\Services\UnionPermitAnalysisService;

final class UnionPermitController
{
    ...
    public function analyze(Request $request): Response
    {
        ...
        return Response::json(['data' => (new UnionPermitAnalysisService())->analyze($request->all())]);
    }
}
